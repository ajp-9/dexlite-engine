...
void zim::DeltaTime::start()
{
	m_startTimepoint = std::chrono::high_resolution_clock::now();
}

void zim::DeltaTime::end()
{
...
double zim::DeltaTime::getDeltaTime()
{
	return m_LastTimeDuration_ms;
}

double zim::DeltaTime::getFPS()
{
	return double(1000) / m_LastTimeDuration_ms;
}

double zim::DeltaTime::getCurrentTime()
{
